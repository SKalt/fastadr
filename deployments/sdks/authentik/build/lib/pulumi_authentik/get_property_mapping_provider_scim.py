...
def get_property_mapping_provider_scim(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('authentik:index/getPropertyMappingProviderScim:getPropertyMappingProviderScim', __args__, opts=opts, typ=GetPropertyMappingProviderScimResult, package_ref=_utilities.get_package()).value
...
def get_property_mapping_provider_scim_output(id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('authentik:index/getPropertyMappingProviderScim:getPropertyMappingProviderScim', __args__, opts=opts, typ=GetPropertyMappingProviderScimResult, package_ref=_utilities.get_package())
