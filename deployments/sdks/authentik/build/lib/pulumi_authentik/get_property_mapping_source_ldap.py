...
__all__ = [
    ...
    'AwaitableGetPropertyMappingSourceLdapResult',
    'get_property_mapping_source_ldap',
    'get_property_mapping_source_ldap_output',
]

@pulumi.output_type
class GetPropertyMappingSourceLdapResult:
    """
...
class AwaitableGetPropertyMappingSourceLdapResult(GetPropertyMappingSourceLdapResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPropertyMappingSourceLdapResult(
...
def get_property_mapping_source_ldap(id: Optional[str] = None,
                                     ...
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPropertyMappingSourceLdapResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('authentik:index/getPropertyMappingSourceLdap:getPropertyMappingSourceLdap', __args__, opts=opts, typ=GetPropertyMappingSourceLdapResult, package_ref=_utilities.get_package()).value

    return AwaitableGetPropertyMappingSourceLdapResult(
...
def get_property_mapping_source_ldap_output(id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('authentik:index/getPropertyMappingSourceLdap:getPropertyMappingSourceLdap', __args__, opts=opts, typ=GetPropertyMappingSourceLdapResult, package_ref=_utilities.get_package())
    return __ret__.apply(lambda __response__: GetPropertyMappingSourceLdapResult(
