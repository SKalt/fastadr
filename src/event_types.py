...
from .values_map import MaybeOne, One, ValuesMap, AnyValue, AnyValuesMap
...
Simple = ValuesMap[Literal["SIMPLE"], One[Literal[0, 1, 2, 3]]]
"""
...
"""
DispatchSetpoint = ValuesMap[Literal["DISPATCH_SETPOINT_RELATIVE"], One[float]]
"""
...
"""
ControlSetpoint = ValuesMap[Literal["CONTROL_SETPOINT"], Sequence[AnyValue]]
"""
> Resource dependent setting. Payload value type depends on
> application.
"""
ExportPrice = ValuesMap[Literal["EXPORT_PRICE"], Sequence[float]]  # <-- Q: arity?
"""
...
"""
GreenhouseGas = ValuesMap[Literal["GHG"], One[float]]
"""
> An estimate of marginal GreenHouse Gas emissions, in g/kWh.
> Payload value is float.
"""
Curve = ValuesMap[
    Literal["CURVE"], Annotated[Sequence[Point], annotated_types.Len(min_length=1)]
]
"""
...
"""
OptimumLoadShape = ValuesMap[Literal["OLS"], Sequence[Portion]]
"""
...
ImportCapacitySubscription = ValuesMap[
    Literal["IMPORT_CAPACITY_SUBSCRIPTION"], One[float]
]
"""
...
ImportCapacityReservation = ValuesMap[
    Literal["IMPORT_CAPACITY_RESERVATION"], One[float]
]
"""
...
ImportCapacityReservationFee = ValuesMap[
    Literal["IMPORT_CAPACITY_RESERVATION_FEE"], One[float]
]
"""
...
> associated eventPayloadDescriptor.
"""
ImportCapacityAvailable = ValuesMap[Literal["IMPORT_CAPACITY_AVAILABLE"], One[float]]
"""
...
ImportCapacityPrice = ValuesMap[Literal["IMPORT_CAPACITY_AVAILABLE_PRICE"], One[float]]
"""
> The cost per unit of power of extra import capacity available for
> reservation. Payload is a float, and meaning is indicated by units in
> associated eventPayloadDescriptor.
...
ExportCapacitySubscription = ValuesMap[
    Literal["EXPORT_CAPACITY_SUBSCRIPTION"], One[float]
]
"""
...
ExportCapacityReservation = ValuesMap[
    Literal["EXPORT_CAPACITY_RESERVATION"], One[float]
]
"""
...
ExportCapacityReservationFee = ValuesMap[
    Literal["EXPORT_CAPACITY_RESERVATION_FEE"], One[float]
]
"""
...
> associated eventPayloadDescriptor
"""
ExportCapacityAvailable = ValuesMap[Literal["EXPORT_CAPACITY_AVAILABLE"], One[float]]
"""
> The amount of extra export capacity available for reservation to the
> customer. Payload is a float, and meaning is indicated by units in
> associated eventPayloadDescriptor.
"""
ImportCapacityLimit = ValuesMap[Literal["IMPORT_CAPACITY_LIMIT"], One[float]]
"""
> The cost per unit of power of extra export capacity available for
> reservation. Payload is a float, and meaning is indicated by units in
> associated eventPayloadDescriptor
"""
ExportCapacityLimit = ValuesMap[Literal["EXPORT_CAPACITY_LIMIT"], One[float]]
"""
...
GridEmergencyAlert = ValuesMap[
    Literal["ALERT_GRID_EMERGENCY"], MaybeOne[HumanReadableStr]
]
"""
...
"""
BlackStartAlert = ValuesMap[Literal["ALERT_BLACK_START"], MaybeOne[HumanReadableStr]]
"""
...
PossibleOutageAlert = ValuesMap[
    Literal["ALERT_POSSIBLE_OUTAGE"], MaybeOne[HumanReadableStr]
]
"""
...
> human-readable string describing the alert
"""
FlexAlert = ValuesMap[Literal["ALERT_FLEX_ALERT"], MaybeOne[HumanReadableStr]]
"""
...
"""
FireAlert = ValuesMap[Literal["ALERT_FIRE"], MaybeOne[HumanReadableStr]]
"""
...
"""
FreezingAlert = ValuesMap[Literal["ALERT_FREEZING"], MaybeOne[HumanReadableStr]]
"""
...
> the alert
"""
WindAlert = ValuesMap[Literal["ALERT_WIND"], MaybeOne[HumanReadableStr]]
"""
> There is (or is forecast to be) wind speeds high enough to be of
> concern. Includes hurricanes. Payload value contains a
> human-readable string describing the alert.
"""
TsunamiAlert = ValuesMap[Literal["ALERT_TSUNAMI"], MaybeOne[HumanReadableStr]]
"""
> Tsunami waves expected to hit the coastline. Payload value contains a
> human-readable string describing the alert.
"""
AirQualityAlert = ValuesMap[Literal["ALERT_AIR_QUALITY"], MaybeOne[HumanReadableStr]]
"""
> Air quality is or is forecast to be. Payload value contains a
> human-readable string describing the alert
"""
OtherAlert = ValuesMap[Literal["ALERT_OTHER"], MaybeOne[HumanReadableStr]]
"""
No specific definition. See associated text data element. Payload value
contains a human-readable string describing the alert
"""

Reboot = ValuesMap[Literal["REBOOT"], One[Literal[0, 1]]]  # Q: arity?
"""
...
OverrideStatus = ValuesMap[
    Literal["CTA2045_SET_OVERRIDE_STATUS"], One[Literal[0, 1]]  # Q: arity?
]
"""
